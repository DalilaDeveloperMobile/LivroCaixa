        ...
        <div class="container">
            ...
            if ($resultado == '' ) : ?>
                ...
                <table class="bordered centered">
                  ...
                  echo   "<td> <h6>  ID  <br>"  .$formdizimo["codi"] ."<td><h6>  Formulario  <br>"."<br> Saida: " .$formdizimo['endereco']. "</h6></h6> </td>"; 

                    
                            ?>

                  
                <td><a href='Deletar1Dizimo.php?codi=<?php  echo $formdizimo['codi'] ; ?>'><h5>Excluir</h5></a></td>
...
<br>
                             ...
                             <legend><h5 style="background-color:  #A52A2A; color: #fff;"> 2.CONTAS SAIDA  </h5></legend>
                                ...
                                <h5 style="color: #fff;"><?= $formdizimo['endereco'] ?></h5> 
                                ...
                                <h5 style="color: #fff;"><?= $formdizimo['congregacao'] ?></h5>
...
<td><a href='Somat.php?codi=<?php  echo $formdizimo['codi'] ; ?>'class="btn btn-orange" target="_blank" >LIVRO CAIXA</a></td>

                    </tbody>
                </table>
                <a href="impressaoSaida1.php?mezi=<?= $_POST['mespesquisa']?>" class="btn btn-orange" target="_blank"> Imprimir </a>
                <?php
            else:
                ?>
