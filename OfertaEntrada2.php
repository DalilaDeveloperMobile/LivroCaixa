...
<body style=" background-color: #20655d;">
    <nav class="light-blue lighten-1" role="navigation">
       ...
       <img src="img/13.png" align="center" class="card-img-top" alt="Card image cap"  width="150"> -->
        ...
        <h6 style=" display: inline-block; font-size: 35px; float: right; margin-right: 20px; margin-top: 10px; color: #fff;">FO.Entrada</h6><img  style=" display: inline-block; float: right; " src="Logos/form5.png" align="center" class="card-img-top" alt="Card image cap"  width="55">
...
<div class="container" style="text-align: center;">
    ...
    <form class="col s12" method="POST" action="verificaOferta.php">
        
        <div id="formoferta">

    <legend><h5 style="background-color:  #228B22; font-size:20px;"> 1.CONTAS ENTRADA OFERTA</h5></legend>
          ...
          <div style="margin-top: 5px;" class="row">
            <div class="input-field col s12">
                ...
                <h6 style="color: #fff;" style="text-align: center; align-items: center; justify-content: center"  for="responsaa">NOME DA ENTRADA DO CAIXA
                </h6>
                <textarea id="responsaa" style="font-size:15px; border-radius: 15px; height: 7px; color:#000; background-color: #fff; margin-bottom: 5px;  margin-top: 20px;  margin: 0 auto; " class="materialize-textarea" name="responsaa" required=""></textarea>
                 <p style="color: #fff; font-size:15px; text-align: center; align-items: center; justify-content: center;">Digite 30/03/2020 Oferta Irmã Dalila Valor 30.00</p>
        ...
        <div style="margin-top: 5px;" class="row">
            <div class="input-field col s12">
                <i class="material-icons prefix"></i>
                 <h6 style="color: #fff;" style="text-align: center; align-items: center; justify-content: center"  for="pastoresa">VALOR DA ENTRADA DO CAIXA
                </h6>
                <textarea id="pastoresa" style="font-size:15px; border-radius: 15px; height: 7px; color:#000; background-color: #fff; margin-bottom: 5px;  margin-top: 20px;  margin: 0 auto; "  class="materialize-textarea" name="pastoresa" required=""></textarea>
