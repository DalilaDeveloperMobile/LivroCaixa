...
<body style=" background-color: #20655d;">
    <nav class="light-blue lighten-1" role="navigation">
       ...
       <img src="img/13.png" align="center" class="card-img-top" alt="Card image cap"  width="150"> -->
        ...
        <h6 style=" display: inline-block; font-size: 35px; float: right; margin-right: 20px; margin-top: 10px; color: #fff;">Formulário</h6><img  style=" display: inline-block; float: right; " src="Logos/form5.png" align="center" class="card-img-top" alt="Card image cap"  width="55">
...
<br>
       ...
       <a href="FormularioDizmo.php" style="display:  block; box-shadow: 5px -5px 3px #000; width: 200px; height: 130px; margin: 0 auto; border-radius: 20px; " class="btn-large waves-effect waves-light blue">
        ...
        <h5 style="color: #fff;">Formulário Dízimo</h5></a>
        
        <br>
        
         <a href="FormularioOferta.php" style="display:  block; box-shadow: 5px -5px 3px #000; width: 200px; height: 130px; margin: 0 auto; border-radius: 20px; " class="btn-large waves-effect waves-light blue">
        ...
        <h5 style="color: #fff;">Formulário Oferta</h5></a>
