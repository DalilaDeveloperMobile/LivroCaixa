...
<html lang="pr-br">
 ...
 <img src="img/13.png" align="center" class="card-img-top" alt="Card image cap"  width="150">
           ...
           -->
                 ...
                 <h6 style=" display: inline-block; font-size: 35px; float: right; margin-right: 50px; margin-top: 10px;">Monitor</h6><img  style=" display: inline-block; float: right;" src="Logos/admin.png" align="center" class="card-img-top" alt="Card image cap"  width="55">
...
<br>
       ...
       <a href="Dizmo.php" style="display:  block; box-shadow: 5px -5px 3px #000; width: 200px; height: 130px; margin: 0 auto; border-radius: 20px; " class="btn-large waves-effect waves-light blue">

        <img  style="border-radius: 25px; top: 8px; width: 98px;" src="dizimo.jpg" align="center" class="card-img-top" alt="Card image cap"  width="90">

        <br>

        <h5 style="color: #fff;">Dízimo</h5></a>
        
        <br>
        
         <a href="Oferta.php" style="display:  block; box-shadow: 5px -5px 3px #000; width: 200px; height: 130px; margin: 0 auto; border-radius: 20px; " class="btn-large waves-effect waves-light blue">

        <img  style="border-radius: 25px; top: 8px; width: 98px;" src="oferta.jpg" align="center" class="card-img-top" alt="Card image cap"  width="90">

        <br>

        <h5 style="color: #fff;">Oferta</h5></a>
