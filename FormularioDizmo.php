...
<body style=" background-color: #20655d;">
    <nav class="light-blue lighten-1" role="navigation">
       ...
       <img src="img/13.png" align="center" class="card-img-top" alt="Card image cap"  width="150"> -->
        ...
        <h6 style=" display: inline-block; font-size: 35px; float: right; margin-right: 50px; margin-top: 10px; color: #fff;">F.DÍZIMO</h6><img  style=" display: inline-block; float: right; " src="Logos/form5.png" align="center" class="card-img-top" alt="Card image cap"  width="55">
...
<br>
       ...
       <a href="DizmoEntrada1.php" style="display:  block; box-shadow: 5px -5px 3px #000; width: 200px; height: 130px; margin: 0 auto; border-radius: 20px; " class="btn-large waves-effect waves-light blue">
        ...
        <br>
         ...
         <a href="DizmoSaida1.php" style="display:  block; box-shadow: 5px -5px 3px #000; width: 200px; height: 130px; margin: 0 auto; border-radius: 20px; " class="btn-large waves-effect waves-light blue">
