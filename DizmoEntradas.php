            ...
            if ($resultado == '' ) : ?>
                ...
                <table class="bordered centered">
                    ...
                    <tbody>
                        ...
                        <?php
                        while ($formulario = $resultado->fetch_assoc()):
                           


              
                  echo   "<td> <h6>  ID  <br>"  .$formulario["id"] ."<td><h6>  Formulario  <br>". "Entrada: " . $formulario['responsa'] . "</h6></h6> </td>"; 

                    
                            ?>

                  
                <td><a href='Deletar.php?id=<?php  echo $formulario['id'] ; ?>'><h5>Excluir</h5></a></td>
...
<br>
                          ...
                          <legend><h5 style="background-color:  #228B22; color: #fff;"> 1.CONTAS ENTRADA </h5></legend>
                          
                                    <br>
                          
                                 <fieldset>
                                 <legend style="font-size:17px;">NOME DA ENTRADA DO CAIXA</legend>

                                <h5 style="color: #fff;"><?= $formulario['responsa'] ?></h5>
                               ...
                               <fieldset>
                                 <legend style="font-size:17px;">VALOR DA ENTRADA DO CAIXA</legend>

                                 <h5 style="color: #fff;"><?= $formulario['pastores'] ?></h5>
...
<td><a href='Somat.php?id=<?php  echo $formulario['id'] ; ?>'class="btn btn-orange" target="_blank" >LIVRO CAIXA</a></td>

                    </tbody>
                </table>
                <a href="impressaoEntada1.php?mes=<?= $_POST['mespesquisa']?>" class="btn btn-orange" target="_blank"> Imprimir </a>
                <?php
            else:
                ?>
