        ...
        <div class="container">
            ...
            if ($resultado == '' ) : ?>
                ...
                <table class="bordered centered">
                  ...
                  echo   "<td> <h6>  ID  <br>"  .$formoferta['cod'] ."<td><h6>  Formulario  <br>". "Entrada: " . $formoferta['responsaa'] . "</h6></h6> </td>"; 

                    
                            ?>

                  
                <td><a href='Deletar2.php?cod=<?php  echo $formoferta['cod'] ; ?>'><h5>Excluir</h5></a></td>
...
<br>
                          ...
                          <legend><h5 style="background-color:  #228B22; color: #fff;"> 1.CONTAS ENTRADA </h5></legend>
                                ...
                                <h5 style="color: #fff;"><?= $formoferta['responsaa'] ?></h5>
                               ...
                               <fieldset>
                                 ...
                                 <h5 style="color: #fff;"><?= $formoferta['pastoresa'] ?></h5>
...
<td><a href='Somad.php?cod=<?php  echo $formoferta['cod'] ; ?>'class="btn btn-orange" target="_blank" >LIVRO CAIXA</a></td>

                    </tbody>
                </table>
                <a href="impressao2Entrada.php?mese=<?= $_POST['mespesquisa']?>" class="btn btn-orange" target="_blank"> Imprimir </a>
                <?php
            else:
                ?>
